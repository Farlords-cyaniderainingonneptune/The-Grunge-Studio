...
export const resendVerificationCode = async (req, res) => {
   ...
   // generate unique identifier/otp
    ...
    const Content =`Hello ${userDetails.full_name}, kindly verify your account using this OTP: ${verificationCode}. This OTP will expire in ${verificationCodeDuration} mins.`
    await sendMail(email,'Verify Your Account', Content);
